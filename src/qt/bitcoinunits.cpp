...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("MLCcoins"));
    case mBTC: return QString(QObject::tr("Milli-MLCcoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-MLCcoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
